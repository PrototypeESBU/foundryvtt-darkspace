...
const SRC_LINT_PATHS = ["./module/darkspace.mjs","./module/scripts/"];

// Compile javascript source files into a single output file.
//
async function compileJavascript() {
	const bundle = await rollup({
		input: "./module/darkspace.mjs",
		plugins: [nodeResolve()],
	});
	await bundle.write({
		file: "./module/darkspace-compiled.mjs",
		format: "es",
		sourcemap: true,
		sourcemapFile: "./module/darkspace.mjs",
	});
}
